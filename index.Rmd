...
description: "A Handbook for the TSL Data Science Course"
---
...
tibble::tibble(
    ...
    `Description` = c("link","link","link","link")
...
```{r, echo=FALSE, warning=FALSE, Message=FALSE}
tibble::tibble(
    `Date` = c("2021-10-04 13:00", "2021-10-11 13:00", "2021-10-29 13:00", "2021-11-12 13:00", "2021-11-26 13:00", "2021-12-10 13:00", "2022-1-7 13:00", "2022-1-21 13:00" ),
    `Session` = c("Course Intro and Intro to Genomics", "Intro to Genomics and Databases", "Data Exploration and Visualistion", "Understanding Statistics", "Literate Computation", "Beginning Programming", "Non-Frequentist Stats", "Machine Learning"),
