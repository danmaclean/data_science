...
tibble::tibble(
    ...
    `Session` = c("Course Intro and Intro to Genomics", "Intro to Genomics", "Data Exploration and Visualistion", "Understanding Statistics", "Literate Computation", "Beginning Programming", "Non-Frequentist Stats", "Machine Learning"),
